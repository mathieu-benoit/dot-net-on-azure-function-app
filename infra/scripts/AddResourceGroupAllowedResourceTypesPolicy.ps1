...
$allowedResourceTypesArrayValue = @("microsoft.insights/components", "Microsoft.Storage/storageAccounts", "Microsoft.Web/serverFarms", "Microsoft.Web/sites", "Microsoft.Web/sites/slots");
